...
<Figure
  src="/articles/fourth-down/conversion-rates.png"
  alt="Raw 4th down conversion rates by yards to go, 1999–2025"
  caption="Raw 4th down conversion rates by yards to go, 1999–2025. On 4th & 1, teams convert two-thirds of the time. Even on 4th & 4–6, the success rate is nearly a coin flip."
/>
...
<Figure
  src="/articles/fourth-down/field-decision-map.png"
  alt="Optimal 4th down call at every field position for each yards-to-go category"
  caption="The historically optimal 4th down call at every field position for each yards-to-go category, averaged across all game situations. The zones are more aggressive than most fans — and most coaches — expect."
  aspect="1536 / 906"
/>
...
<Figure
  src="/articles/fourth-down/go-for-it-trend.png"
  alt="NFL-wide go-for-it rate on fourth down, 1999–2025"
  caption="NFL-wide go-for-it rate on fourth down, 1999–2025. The analytics revolution is real — but it arrived late and has plateaued."
  aspect="1536 / 349"
/>
...
<Figure
  src="/articles/fourth-down/wpa-left-on-table.png"
  alt="Total WPA left on the table each season from suboptimal 4th down decisions, 1999–2025"
  caption="Total WPA left on the table each season from suboptimal 4th down decisions, 1999–2025. The gap is narrowing — but it hasn't closed."
  aspect="1536 / 632"
/>
...
<Figure
  src="/articles/fourth-down/wrong-call-heatmap.png"
  alt="Wrong-call rate by field position and yards to go"
  caption="Wrong-call rate by field position and yards to go. Darker red = coaches make the suboptimal call more often."
  aspect="4 / 3"
/>
